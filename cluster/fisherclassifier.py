...
#  Description:
#
#   Following program is to train and classfy numerical data by Fisher's linear method.
...
class FisherClassifier:
    ...
    def test(self, dataset, printlog=0):
        ...
        print "Result:"
        print "Correct Case: ", cnt_correct
        print "Wrong   Case: ", cnt_wrong
